...
struct PremiumView: View {
    ...
    private var fallbackPlans: some View {
        VStack(spacing: 10) {
            planCard(title: NSLocalizedString("premium_plan_weekly", comment: ""), price: "$4.99", id: StoreProductID.premiumWeekly.rawValue, subTitle: "1,000 " + NSLocalizedString("premium_plan_diamonds_suffix", comment: ""))
            planCard(title: NSLocalizedString("premium_plan_monthly", comment: ""), price: "$12.99", id: StoreProductID.premiumMonthly.rawValue, subTitle: "3,000 " + NSLocalizedString("premium_plan_diamonds_suffix", comment: ""), tag: NSLocalizedString("premium_tag_popular", comment: ""))
